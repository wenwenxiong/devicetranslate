...
type DeviceSpec struct {
	...
	DeviceModelRef *v1.LocalObjectReference `json:"deviceModelRef,omitempty" yaml:"deviceModelRef,omitempty"`
	...
	// +optional
	PropertyVisitors []DevicePropertyVisitor `json:"propertyVisitors,omitempty" yaml:"propertyVisitors,omitempty"`
	// Data section describe a list of time-series properties which should be processed
	// on edge node.
	// +optional
	Data DeviceData `json:"data,omitempty" yaml:"data,omitempty"`
	...
	// +optional
	NodeSelector *v1.NodeSelector `json:"nodeSelector,omitempty" yaml:"nodeSelector,omitempty"`
}
...
type DeviceStatus struct {
	...
	// +optional
	Twins []Twin `json:"twins,omitempty" yaml:"twins,omitempty"`
}
...
type Twin struct {
	...
	Desired TwinProperty `json:"desired,omitempty" yaml:"desired,omitempty"`
	// Required: the reported property value.
	Reported TwinProperty `json:"reported,omitempty" yaml:"reported,omitempty"`
}
