...
type DeviceModelSpec struct {
	...
	Properties []DeviceProperty `json:"properties,omitempty" yaml:"properties,omitempty"`
}
...
type PropertyType struct {
	// +optional
	Int *PropertyTypeInt64 `json:"int,omitempty" yaml:"int,omitempty"`
	// +optional
	String *PropertyTypeString `json:"string,omitempty" yaml:"string,omitempty"`
	// +optional
	Double *PropertyTypeDouble `json:"double,omitempty" yaml:"double,omitempty"`
	// +optional
	Float *PropertyTypeFloat `json:"float,omitempty" yaml:"float,omitempty"`
	// +optional
	Boolean *PropertyTypeBoolean `json:"boolean,omitempty" yaml:"boolean,omitempty"`
	// +optional
	Bytes *PropertyTypeBytes `json:"bytes,omitempty" yaml:"bytes,omitempty"`
}

type PropertyTypeInt64 struct {
	// Required: Access mode of property, ReadWrite or ReadOnly.
	AccessMode PropertyAccessMode `json:"accessMode,omitempty" yaml:"accessMode,omitempty"`
	// +optional
	DefaultValue int64 `json:"defaultValue,omitempty" yaml:"defaultValue,omitempty"`
	// +optional
...
type PropertyTypeDouble struct {
	...
	AccessMode PropertyAccessMode `json:"accessMode,omitempty" yaml:"accessMode,omitempty"`
	// +optional
	DefaultValue float64 `json:"defaultValue,omitempty" yaml:"defaultValue,omitempty"`
	// +optional
...
type PropertyTypeFloat struct {
	...
	AccessMode PropertyAccessMode `json:"accessMode,omitempty" yaml:"accessMode,omitempty"`
	// +optional
	DefaultValue float32 `json:"defaultValue,omitempty" yaml:"defaultValue,omitempty"`
	// +optional
	Minimum float32 `json:"minimum,omitempty" yaml:"minimum,omitempty"`
	// +optional
	Maximum float32 `json:"maximum,omitempty" yaml:"maximum,omitempty"`
	// The unit of the property
	// +optional
	Unit string `json:"unit,omitempty" yaml:"unit,omitempty"`
}
...
type PropertyTypeBoolean struct {
	...
	AccessMode PropertyAccessMode `json:"accessMode,omitempty" yaml:"accessMode,omitempty"`
	// +optional
	DefaultValue bool `json:"defaultValue,omitempty" yaml:"defaultValue,omitempty"`
}
...
type DeviceModel struct {
	...
	Spec DeviceModelSpec `json:"spec,omitempty" yaml:"spec,omitempty"`
}
...
type DeviceModelList struct {
	...
	Items           []DeviceModel `json:"items" yaml:"items"`
}
